...
class WebSocketClient {
  ...
  reconnect() {
    ...
    console.log(
      `🔄 Reconnect attempt ${this.reconnectAttempts} sau ${delay}ms...`
    );
...
<html lang="vi">
  ...
  <body>
    ...
    <div id="chatContainer" class="chat-container">
      <div class="message system">Chào mừng đến với WebSocket Chat App!</div>
    </div>
    ...
    <script>
      ...
      class ChatApp {
        ...
        showTyping(username, isTyping) {
          ...
          console.log(
            `⌨️ ${username} ${isTyping ? "đang gõ..." : "đã dừng gõ"}`
          );
        }
